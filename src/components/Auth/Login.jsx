...
export default function Login({handleLogin}) {
  ...
  return (
    <div className='flex static h-screen w-screen items-center justify-center'>
        <p className='absolute top-0 left-0'>adminEmail-admin@me.com</p>
        <p className='absolute top-4 left-0'>employees1Email-employee1@example.com</p>
        <p className='absolute top-8 left-0'>Password-123</p>
